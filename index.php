...
if (isset($_GET["transaksi"])) {
    ...
    $menu = ambil_data("SELECT DISTINCT p.kode_pesanan, tk.nama_pelanggan, p.qty
...
<body class="bg-light">
    ...
    <div id="dropdown-menu" class="container-fluid position-fixed float-start bg-dark text-white w-auto vh-100" style="display: none; z-index: 1; top: 50px;">
        ...
        <ul>
            ...
            <li><a class="text-decoration-none p-2 h5 text-light" href="index.php?laporan_penjualan">LAPORAN PENJUALAN</a></li>
            <?php } ?>
    ...
    else if (isset($_GET["laporan_penjualan"])) include "halaman/laporan_penjualan.php";
    

    else if (isset($_GET["menu"])) include "halaman/menu.php";

    else if (isset($_GET["tambah-menu"])) include "halaman/tambah-menu.php";

    else if (isset($_GET["edit-menu"])) include "halaman/edit-menu.php";

    else if (isset($_GET["hapus-menu"])) include "halaman/hapus-menu.php";

    else if (isset($_GET["detail-pesanan-admin"])) include "halaman/detail-pesanan-admin.php";

    else if (isset($_GET["detail-pesanan"])) include "halaman/detail-pesanan.php";
